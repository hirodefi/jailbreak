...
import AirdropDetail from '../components/airdropAdmin/AirdropDetail';
import AdminAirdropClaims from '../components/airdropAdmin/AdminAirdropClaims';
import { useNavigate } from "react-router";


const AdminAirdropDetailPage: React.FC = () => {
    ...
    return (
        <Box sx={{ backgroundColor: "#0d0a29", margin: "0px", py: 4, minHeight: 'calc(100vh - 115px)' }}>
            ...
            <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }} >
                <AdminAirdropClaims></AdminAirdropClaims>
...
export default AdminAirdropDetailPage;
